    ...
    public void onKeyInput(InputEvent.KeyInputEvent event){
        ...
        if(ClientProxy.breath.isKeyDown()){
            if(player1.getCapability(SlayerProvider.Breath_CAP, null).getMana() != player1.getCapability(SlayerProvider.Breath_CAP, null).getMaxMana()) {
                ...
                Networking.sendTo(new SlayerMessage(player1.getCapability(SlayerProvider.Breath_CAP, null).getBreath(), player1.getCapability(SlayerProvider.Breath_CAP, null).getMana(), player1.getCapability(SlayerProvider.Breath_CAP, null).getXP(), player1.getCapability(SlayerProvider.Breath_CAP, null).getLevel(), player1.getCapability(SlayerProvider.Breath_CAP, null).getMaxMana()), (EntityPlayerMP) player1);
