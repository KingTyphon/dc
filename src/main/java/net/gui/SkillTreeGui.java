...
public class SkillTreeGui extends GuiScreen {
    ...
    private void initializeWaterSkillTooltips() {
        ...
        waterSkillTooltips.add("Fifth Form: Blessed Rain After the Drought (Go no kata: Kanten no Jiu?)[11] - The user changes the grip on their sword and decapitates the opponent in a single flowing strike that causes little to no pain. It is a “sword strike of kindness” used when the enemy willingly surrenders.");
