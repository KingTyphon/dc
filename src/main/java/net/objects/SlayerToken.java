    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            if (number == 1) {
                ...
                Networking.sendToServer(new SlayerMessage(1, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(1, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            ...
            if (number == 2) {
                ...
                Networking.sendToServer(new SlayerMessage(2, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(2, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
                }
            if (number == 3) {
                ...
                Networking.sendToServer(new SlayerMessage(3, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(3, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 4) {
                ...
                Networking.sendToServer(new SlayerMessage(4, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(4, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 5) {
                ...
                Networking.sendToServer(new SlayerMessage(5, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(5, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 6) {
                ...
                Networking.sendToServer(new SlayerMessage(6, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(6, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 7) {
                ...
                Networking.sendToServer(new SlayerMessage(7, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(7, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 8) {
                ...
                Networking.sendToServer(new SlayerMessage(8, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(8, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 9) {
                ...
                Networking.sendToServer(new SlayerMessage(9, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(9, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            ...
            if (number == 10) {
                ...
                Networking.sendToServer(new SlayerMessage(10, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(10, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 11) {
                ...
                Networking.sendToServer(new SlayerMessage(11, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(11, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 12) {
                ...
                Networking.sendToServer(new SlayerMessage(12, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(12, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 13) {
                ...
                Networking.sendToServer(new SlayerMessage(13, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(13, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }
            if (number == 14) {
                ...
                Networking.sendToServer(new SlayerMessage(14, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(14, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            ...
            if (number == 15) {
                ...
                Networking.sendToServer(new SlayerMessage(15, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(15, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            ...
            if (number == 16) {
                ...
                Networking.sendToServer(new SlayerMessage(16, 0.0F, 0, 1, 250));
                Networking.sendTo(new SlayerMessage(16, 0.0F, 0, 1, 250), (EntityPlayerMP) playerIn);
            }

            playerIn.fallDistance = 0;
            Networking.sendToServer(new TechMessage(playerIn));
            Networking.sendTo(new TechMessage(playerIn), (EntityPlayerMP) playerIn);
