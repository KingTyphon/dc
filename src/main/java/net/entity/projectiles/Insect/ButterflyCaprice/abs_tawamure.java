package net.entity.projectiles.Insect.ButterflyCaprice;
...
import net.util.handlers.particle_enum;
import net.util.handlers.particle_spawns;
...
public abstract class abs_tawamure extends Entity
{
    ...
    public abs_tawamure(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_tawamure(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
        setSize(4.0F, 4.0F);
        setPosition(x, y, z);
    }

    public abs_tawamure(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
            ...
            this.motionY *= f;
            this.motionZ *= f;
            double x_pos = this.posX ;
            double y_pos = this.posY ;
            double z_pos = this.posZ ;
            if(this.world.isRemote){
                particle_spawns.spawnParticle(particle_enum.BUTTERFLY, x_pos, y_pos, z_pos,((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
            }
