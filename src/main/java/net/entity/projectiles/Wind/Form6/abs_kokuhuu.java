...
public abstract class abs_kokuhuu
        extends Entity
{
    ...
    public abs_kokuhuu(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_kokuhuu(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_kokuhuu(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
            ...
            this.world.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, this.posX+(0.2 * r.nextInt(5)), this.posY +(0.5 * r.nextInt(5)), this.posZ+(0.2 * r.nextInt(5)), 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.posX+(0.1 * r.nextInt(5)), this.posY +(0.2 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)), 0.0D, 0.0D, 0.0D, new int[0]);
