...
public abstract class abs_kokuhuu_hit
        extends Entity
{
    ...
    public abs_kokuhuu_hit(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_kokuhuu_hit(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_kokuhuu_hit(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
