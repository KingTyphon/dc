...
public abstract class abs_sinato_hit extends Entity
{
    ...
    public abs_sinato_hit(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_sinato_hit(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
        setSize(4.0F, 4.0F);
        setPosition(x, y, z);
    }

    public abs_sinato_hit(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (!this.getEntityWorld().isRemote) {
            this.world.createExplosion(null, this.posX, this.posY, this.posZ,   0.7F, true);

            setDead();
        }

//		if(tick_living==1)setDead();
