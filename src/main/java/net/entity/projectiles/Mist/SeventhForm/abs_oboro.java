...
public abstract class abs_oboro
        extends Entity
{
    ...
    public abs_oboro(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_oboro(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_oboro(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
            ...
            this.world.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE,this.posX+(0.4 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)), 0.0D, 0.0D, 0.0D, new int[0]);
