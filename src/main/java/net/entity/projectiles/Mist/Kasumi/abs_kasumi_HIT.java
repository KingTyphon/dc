package net.entity.projectiles.Mist.Kasumi;
...
public abstract class abs_kasumi_HIT
        extends Entity
{
    ...
    public abs_kasumi_HIT(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_kasumi_HIT(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_kasumi_HIT(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
