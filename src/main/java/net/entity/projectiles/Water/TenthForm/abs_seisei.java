...
public abstract class abs_seisei extends Entity
{
    ...
    public abs_seisei(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_seisei(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_seisei(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
