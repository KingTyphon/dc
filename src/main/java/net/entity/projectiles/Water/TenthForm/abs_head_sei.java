package net.entity.projectiles.Water.TenthForm;
...
public abstract class abs_head_sei extends Entity
{
    ...
    public abs_head_sei(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_head_sei(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_head_sei(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
            ...
            this.world.spawnParticle(EnumParticleTypes.SWEEP_ATTACK, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.WATER_DROP, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.WATER_DROP, this.posX+0.1D, this.posY + 0.1D, this.posZ+0.1D, 0.0D, 0.0D, 0.0D, new int[0]);
