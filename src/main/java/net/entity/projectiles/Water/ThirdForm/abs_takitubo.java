package net.entity.projectiles.Water.ThirdForm;
...
public abstract class abs_takitubo
        extends Entity
{
    ...
    public abs_takitubo(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_takitubo(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_takitubo(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
