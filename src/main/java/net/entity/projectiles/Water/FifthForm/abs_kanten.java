...
public abstract class abs_kanten
        extends Entity
{
    ...
    public abs_kanten(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_kanten(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_kanten(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
            ...
            this.world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX-0.2D, this.posY - 3.5D, this.posZ-0.7D, 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.WATER_DROP, this.posX+0.6D, this.posY + -3.1D, this.posZ+0.1D, 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX+0.3D, this.posY - 3.9D, this.posZ + 0.3D, 0.0D, 0.0D, 0.0D, new int[0]);
            this.world.spawnParticle(EnumParticleTypes.WATER_DROP, this.posX-0.2D, this.posY + -3.7D, this.posZ-0.4D, 0.0D, 0.0D, 0.0D, new int[0]);
