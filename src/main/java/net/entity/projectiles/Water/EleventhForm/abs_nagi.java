...
public abstract class abs_nagi
        extends Entity
{
    ...
    public abs_nagi(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_nagi(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
