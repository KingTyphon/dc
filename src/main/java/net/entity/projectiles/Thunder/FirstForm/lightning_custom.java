...
public class lightning_custom extends abs_lightning {
    public int explosionPower = 1;
    public long boltVertex;

    public lightning_custom(World worldIn) {
        super(worldIn);
    ...
    public lightning_custom(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn, x, y, z, accelX, accelY, accelZ);
    }

    public lightning_custom(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
