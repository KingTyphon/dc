package net.entity.projectiles.Thunder.FirstForm;
...
public abstract class abs_lightning2
        extends Entity
{
    ...
    public abs_lightning2(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_lightning2(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_lightning2(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
