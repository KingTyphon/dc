...
public abstract class abs_lightning extends Entity
{
    ...
    public abs_lightning(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_lightning(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
        setSize(4.0F, 4.0F);
    ...
    public abs_lightning(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
