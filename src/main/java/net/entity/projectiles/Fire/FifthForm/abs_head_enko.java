...
public abstract class abs_head_enko extends Entity
{
    ...
    public abs_head_enko(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_head_enko(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_head_enko(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
