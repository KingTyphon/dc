...
public abstract class abs_enten_HIT extends Entity
{
    ...
    public abs_enten_HIT(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_enten_HIT(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
        setSize(4.0F, 4.0F);
        setPosition(x, y, z);
    }

    public abs_enten_HIT(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
