package net.entity.projectiles.Beast.Ugatinuki;
...
public abstract class abs_ugatinuki
        extends Entity
{
    ...
    public abs_ugatinuki(World worldIn) {
        super(worldIn);
    }
    ...
    public abs_ugatinuki(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
    ...
    public abs_ugatinuki(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
