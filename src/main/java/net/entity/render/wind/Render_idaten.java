...
public class Render_idaten extends Render<idaten> {
    ...
    public Render_idaten(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(idaten entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(idaten entity) {
        return TEXTURE;
    }
}