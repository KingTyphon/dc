...
public class Render_sogi extends Render<HIT_sogi> {
    ...
    public Render_sogi(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(HIT_sogi entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(HIT_sogi entity) {
        return TEXTURE;
    }
}