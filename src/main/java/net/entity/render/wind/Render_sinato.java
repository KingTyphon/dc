...
public class Render_sinato extends Render<sinato> {
    ...
    public Render_sinato(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(sinato entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(sinato entity) {
        return TEXTURE;
    }
}