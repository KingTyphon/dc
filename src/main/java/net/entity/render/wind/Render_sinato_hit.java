...
public class Render_sinato_hit extends Render<sinato_hit> {
    ...
    public Render_sinato_hit(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(sinato_hit entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(sinato_hit entity) {
        return TEXTURE;
    }
}