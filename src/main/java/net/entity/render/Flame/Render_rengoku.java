...
public class Render_rengoku extends Render<HIT_rengoku> {
    ...
    public Render_rengoku(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(HIT_rengoku entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(HIT_rengoku entity) {
        return TEXTURE;
    }
}
