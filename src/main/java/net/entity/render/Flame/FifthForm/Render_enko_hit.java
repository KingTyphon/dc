package net.entity.render.Flame.FifthForm;
...
public class Render_enko_hit extends Render<enkoHIT_head> {
    ...
    public Render_enko_hit(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(enkoHIT_head entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(enkoHIT_head entity) {
        return TEXTURE;
    }}
